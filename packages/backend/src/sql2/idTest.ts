...
export const isMethodRefId = (id: AnyOwnerId): id is MethodDefId => isTableId(strip(id), TableId.MethodSpec);
export const isTypeRefId = (id: AnyOwnerId): id is MethodDefId => isTableId(strip(id), TableId.TypeRef);
